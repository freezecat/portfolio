<div id="header">
    <div id="log">
        <?php if(isset($_SESSION["pseudo"]) && $_SESSION["pseudo"]!=""):?>
            <button class="bouton bouton_mon_profil">
			    <?= $_SESSION["pseudo"];?><span class="entypo-down-dir"></span>
			</button>
			...
			<div id="monprofil_params">
			    <ul>
					<li>
					    ...
					    <a href="index.php?page=monprofil">Mon profil</a>
					</li>
					<li>
					...
					<li>
						...
						<a href="index.php?page=logout">Deconnection</a>
					</li>
			    </ul>
			</div>
		<?php else:?>
    ...
    <div class="navigation">
        <a href="index.php">
	        <span  style="margin-left:2rem; font-size:2rem; top:10px; color:red;" class="entypo-home" title="Accueil"></span>
	    </a>
	 
        <a href="index.php?page=panier">
		    <span style="margin-left:2rem; font-size:2rem; top:10px; color:green;" class="fontawesome-shopping-cart" title="Votre panier"></span>
	    </a>
		
  	    <?php if(isset($_SESSION["statut"]) && $_SESSION["statut"]=="administrateur"):?>
			<a href="index.php?page=add">
			    <span style="margin-left:2rem; font-size:2rem; top:10px; color:purple;" class="iconicstroke-plus-alt" title="Ajouter un article"></span>
			</a>
			<a href="index.php?page=delete">
			    <span  style="margin-left:2rem; font-size:2rem; top:10px; color:brown;" class="entypo-cup" title="Supprimer un article"></span>
		    </a>
		<?php endif;?>
    </div>
