<div id="alerte"><span class='alerte_msg'>Identifiez-vous !<a href='index.php?page=login'>Log In</a></span><div id='alerte_close' onclick="msg_close('alerte_close')">X</div></div>
<div id="panier">
